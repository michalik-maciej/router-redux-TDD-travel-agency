...
[
  {
    'repeat(25)': {
      ...
      name(tags) {
        const adj =
          'amazing astonishing awesome brilliant excellent fabulous fantastic incredible magnificent marvelous outstanding phenomenal remarkable sensational superb terrific tremendous wondrous'.split(
            ' '
          );
      ...
      tags(tags) {
        const options =
          'all-inclusive child-friendly beach spa pool skiing sightseeing mountains'.split(
            ' '
          );
        const out = [];
